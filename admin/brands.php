...
//engizu batyrmasin baskanda bolatyn eskertuler
if (isset($_POST['add_submit'])) {
	$brand=sanitize($_POST['brand']);
	//eger bos bolsa
	if ($_POST['brand']=='') {
		$errors[].='You must entr a brand!';
	}
//engizgen malmet bazada bar zhogin tekseru
...
if ($count>0) {
	$errors[].=$brand.' markasy bar. Otnem baska marka engizinz....';
}
//eskertudi orindau
	if (!empty($errors)) {
