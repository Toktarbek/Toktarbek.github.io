...
<div class="col-md-4">
<!-- Sales by month eki zhildin ar aida tusken tabisin esepteu-->
<?php
$thisYr=date("Y");
$lastYr=$thisYr-1;
...
<div class="col-md-8">
	...
	<table class="table table-condensed table-striped table-bordered">
		<thead><th>Product</th><th>Category</th><th>Size</th><th>Quantity</th><th>Threshold</th></thead>
		<tbody>
		<?php foreach($lowItems as $item): ?>
			<tr <?=($item['quantity']) == ''?' class="danger"':''; ?>>
				<td><?=$item['title']; ?></td>
				<td><?=$item['category']; ?></td>
				<td><?=$item['size']; ?></td>
				<td><?=$item['quantity']; ?></td>
