...
//Complete order tapsirsty ayaktau zhetkizu
...
$txnQuery="SELECT * FROM transaction WHERE id='{$txn_id}'";
$txnResults=$db->query($txnQuery);
$txn=mysqli_fetch_assoc($txnResults);
$cart_id=$txn['cart_id'];
...
<table class="table table-condensed table-bordered table-striped">
	<thead><th>Quantity</th><th>Title</th><th>Category</th><th>Size</th></thead>
	<tbody>
