...
//katelikterdi eskertu
	if ($_POST) {
		...
		if (strlen($password)<6) {
			$errors[]='You password must be least 6 characters.';
		}
		if ($password != $confirm) {
			$errors[]='You password do not match.';
		}
	...
	<form action="users.php?add=1" method="post">
		...
		<div class="form-group col-md-6">
			<label for="Permissions">Permissins:</label>
...
<table class="table table-bordered table-striped table-condensed">
	<thead>
		<th></th><th>Nme</th><th>Email</th><th>Join Date</th><th>Last Login</th><th>Permissions</th>
		<tbody>
